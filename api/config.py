...
def get_config(model_name="auto"):
    ...
    if config_path is None:
        print(
            f"Warning: No config path provided to ARK. Using default config at {DEFAULT_CONFIG_PATH}."
        )
        print(
            "To actually load a predictive model, set the ARK_CONFIG environment variable."
